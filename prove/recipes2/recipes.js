const recipes = [
	{
		...
		image: '../../images/recipe-images/sweet-potato-waffle-md.jpg',
		recipeIngredient: [
			'2 separated eggs',
			'1/4 C Oil',
			'1/4 tsp salt',
	...
	},
	{
		...
		image: '../../images/recipe-images/escalopes-de-poulet-a-la-creme.webp',
		recipeIngredient: [
	...
	},
	{
		...
		image: '../../images/recipe-images/roasted-potatoes.webp',
		recipeIngredient: [
			'3-4 Medium Potatoes',
			'1 Tbsp Olive oil',
	...
	},
	{
		...
		image: '../../images/recipe-images/black-beans-and-rice.jpg',
		recipeIngredient: [
	...
	},
	{
		...
		image: '../../images/recipe-images/chicken-curry.webp',
		recipeIngredient: [
			'4 Slices Bacon',
			'1 clove Garlic',
			'2 Tbsp Flour',
	...
	},
	{
		...
		image: '../../images/recipe-images/chocolate-chip-cookies.jpg',
		recipeIngredient: [
	...
	},
	{
		...
		image: '../../images/recipe-images/german-gooseberry-cake.jpg',
		recipeIngredient: [
			'For the Cake Base:',
	...
	},
	{
		...
		image: '../../images/recipe-images/apple-crisp.jpg',
		recipeIngredient: [
...
function tagTemplate(tags) {
    return tags
        .map(tag => `<button type="button" class="recipe-button">${tag}</button>`)
        .join(" ");
}
...
function renderRecipe(recipe) {
    let recipeContent = recipeTemplate(recipe);
...
function search() {
  ...
  // sort the filtered results by rating
  filteredRecipes.sort(sortRating);
